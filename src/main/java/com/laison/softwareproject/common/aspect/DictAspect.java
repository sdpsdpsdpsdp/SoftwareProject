...
import com.laison.softwareproject.common.aspect.annotation.Dict;
...
public class DictAspect {
     ...
     * 定义切点Pointcut
     */
    @Pointcut("execution(public * com.laison.softwareproject.controller..*Controller.*(..)) || @annotation(com.laison.softwareproject.common.aspect.annotation.AutoDict)")
    ...
    private Object parseDictText(Object result) {
        if (result instanceof Result) {
            if (((Result) result).getData() instanceof PageInfo) {
                ...
                //取出结果集
                List<Object> records=((PageInfo) ((Result) result).getData()).getList();
                ...
                ((PageInfo) ((Result) result).getData()).setList(items);
            }
