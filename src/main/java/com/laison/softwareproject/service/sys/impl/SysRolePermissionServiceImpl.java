...
import com.laison.softwareproject.dao.sys.SysRolePermissionDao;
...
public class SysRolePermissionServiceImpl implements SysRolePermissionService{
	...
	public int countByCondition(HashMap<String, Object> condition) throws Exception {
		...
		return  sysRolePermissionDao.selectCountByExample(example);
	}
	...
	public int deleteByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return  sysRolePermissionDao.deleteByExample(example);
	}
	...
	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	public int save(SysRolePermission record) throws Exception {
		
		return sysRolePermissionDao.insertSelective(record);
	}

	@Override
	public List<SysRolePermission> selectAllByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		...
		return sysRolePermissionDao.selectByExample(example);
	}

	@Override
	public PageInfo<SysRolePermission> selectPageByCondition(HashMap<String, Object> condition, Integer pageNum, Integer pageSize)
			throws Exception {
		Example example = createExample(condition);
		if(ConfigConstant.ISOLATE_ENABLE) {
			LoginUserUtil.addIsolate(example);
		...
		List<SysRolePermission> list = sysRolePermissionDao.selectByExample(example);
		PageInfo<SysRolePermission> pageInfo = new PageInfo<>(list);
		return pageInfo;
	}

	@Override
	public SysRolePermission selectFirstByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		String orderByClause = (String) condition.get("orderByClause");
		if(orderByClause!=null) {
			example.setOrderByClause(orderByClause);
	...
	public SysRolePermission selectByPrimaryKey(String id) throws Exception {
	...
	@CacheEvict(value=CACHE_NAME,allEntries=true)// 清空  缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByCondition(SysRolePermission record, HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return sysRolePermissionDao.updateByExample(record, example);
	}

	@Override
	@CacheEvict(value =CACHE_NAME, key = "#record.id") // 清除 缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByPrimaryKey(SysRolePermission record) throws Exception {
