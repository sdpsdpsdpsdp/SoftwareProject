...
import com.laison.softwareproject.dao.sys.SysTenantPackUserDao;
...
*/
@Service
public class SysTenantPackUserServiceImpl implements SysTenantPackUserService{
	
	
    @Autowired
	private SysTenantPackUserDao sysTenantPackUserDao;
	...
	public int countByCondition(HashMap<String, Object> condition) throws Exception {
		...
		return  sysTenantPackUserDao.selectCountByExample(example);
	}
	...
	public int deleteByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return  sysTenantPackUserDao.deleteByExample(example);
	}
	...
	public int deleteByPrimaryKey(String id) throws Exception {
		...
		return  sysTenantPackUserDao.deleteByPrimaryKey(id);
	}

	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	public int save(SysTenantPackUser record) throws Exception {
		
		return sysTenantPackUserDao.insertSelective(record);
	}

	@Override
	public List<SysTenantPackUser> selectAllByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		...
		return sysTenantPackUserDao.selectByExample(example);
	}

	@Override
	public PageInfo<SysTenantPackUser> selectPageByCondition(HashMap<String, Object> condition, Integer pageNum, Integer pageSize)
			throws Exception {
		Example example = createExample(condition);
		if(ConfigConstant.ISOLATE_ENABLE) {
			LoginUserUtil.addIsolate(example);
		...
		List<SysTenantPackUser> list = sysTenantPackUserDao.selectByExample(example);
		PageInfo<SysTenantPackUser> pageInfo = new PageInfo<>(list);
		return pageInfo;
	}

	@Override
	public SysTenantPackUser selectFirstByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		String orderByClause = (String) condition.get("orderByClause");
		if(orderByClause!=null) {
			example.setOrderByClause(orderByClause);
	...
	public SysTenantPackUser selectByPrimaryKey(String id) throws Exception {
		return sysTenantPackUserDao.selectByPrimaryKey(id);
	}

	@Override
	@CacheEvict(value=CACHE_NAME,allEntries=true)// 清空  缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByCondition(SysTenantPackUser record, HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return sysTenantPackUserDao.updateByExample(record, example);
	}

	@Override
	@CacheEvict(value =CACHE_NAME, key = "#record.id") // 清除 缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByPrimaryKey(SysTenantPackUser record) throws Exception {
		return sysTenantPackUserDao.updateByPrimaryKeySelective(record);
	}
	...
	public int deleteByPrimaryKeys(List<String> ids) throws Exception {
		Example example =new Example(SysTenantPackUser.class);
