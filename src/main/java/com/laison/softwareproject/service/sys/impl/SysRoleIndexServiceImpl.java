...
import com.laison.softwareproject.dao.sys.SysRoleIndexDao;
...
public class SysRoleIndexServiceImpl implements SysRoleIndexService{
    ...
    @Autowired
	private SysRoleIndexDao sysRoleIndexDao;
	...
	public int countByCondition(HashMap<String, Object> condition) throws Exception {
		...
		return  sysRoleIndexDao.selectCountByExample(example);
	}
	...
	public int deleteByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return  sysRoleIndexDao.deleteByExample(example);
	}
	...
	public int deleteByPrimaryKey(String id) throws Exception {
		...
		return  sysRoleIndexDao.deleteByPrimaryKey(id);
	}

	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	public int save(SysRoleIndex record) throws Exception {
		
		return sysRoleIndexDao.insertSelective(record);
	}

	@Override
	public List<SysRoleIndex> selectAllByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		...
		return sysRoleIndexDao.selectByExample(example);
	}

	@Override
	public PageInfo<SysRoleIndex> selectPageByCondition(HashMap<String, Object> condition, Integer pageNum, Integer pageSize)
			throws Exception {
		Example example = createExample(condition);
		if(ConfigConstant.ISOLATE_ENABLE) {
			LoginUserUtil.addIsolate(example);
		...
		List<SysRoleIndex> list = sysRoleIndexDao.selectByExample(example);
		PageInfo<SysRoleIndex> pageInfo = new PageInfo<>(list);
		return pageInfo;
	}

	@Override
	public SysRoleIndex selectFirstByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		String orderByClause = (String) condition.get("orderByClause");
		if(orderByClause!=null) {
			example.setOrderByClause(orderByClause);
	...
	public SysRoleIndex selectByPrimaryKey(String id) throws Exception {
		return sysRoleIndexDao.selectByPrimaryKey(id);
	}

	@Override
	@CacheEvict(value=CACHE_NAME,allEntries=true)// 清空  缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByCondition(SysRoleIndex record, HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return sysRoleIndexDao.updateByExample(record, example);
	}

	@Override
	@CacheEvict(value =CACHE_NAME, key = "#record.id") // 清除 缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByPrimaryKey(SysRoleIndex record) throws Exception {
		return sysRoleIndexDao.updateByPrimaryKeySelective(record);
	}
	...
	public int deleteByPrimaryKeys(List<String> ids) throws Exception {
		Example example =new Example(SysRoleIndex.class);
