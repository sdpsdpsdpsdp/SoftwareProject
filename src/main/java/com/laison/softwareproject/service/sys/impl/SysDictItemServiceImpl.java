...
import com.laison.softwareproject.dao.sys.SysDictItemDao;
...
public class SysDictItemServiceImpl implements SysDictItemService{
	...
	public int countByCondition(HashMap<String, Object> condition) throws Exception {
		...
		return  sysDictItemDao.selectCountByExample(example);
	}
	...
	public int deleteByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return  sysDictItemDao.deleteByExample(example);
	}
	...
	public int deleteByPrimaryKey(String id) throws Exception {
		...
		return  sysDictItemDao.deleteByPrimaryKey(id);
	}

	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	public int save(SysDictItem record) throws Exception {
		
		return sysDictItemDao.insertSelective(record);
	}

	@Override
	public List<SysDictItem> selectAllByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		...
		return sysDictItemDao.selectByExample(example);
	}

	@Override
	public PageInfo<SysDictItem> selectPageByCondition(HashMap<String, Object> condition, Integer pageNum, Integer pageSize)
			throws Exception {
		Example example = createExample(condition);
		if(ConfigConstant.ISOLATE_ENABLE) {
			LoginUserUtil.addIsolate(example);
		...
		List<SysDictItem> list = sysDictItemDao.selectByExample(example);
		PageInfo<SysDictItem> pageInfo = new PageInfo<>(list);
		return pageInfo;
	}

	@Override
	public SysDictItem selectFirstByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		String orderByClause = (String) condition.get("orderByClause");
		if(orderByClause!=null) {
			example.setOrderByClause(orderByClause);
	...
	public SysDictItem selectByPrimaryKey(String id) throws Exception {
		return sysDictItemDao.selectByPrimaryKey(id);
	}

	@Override
	@CacheEvict(value=CACHE_NAME,allEntries=true)// 清空  缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByCondition(SysDictItem record, HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return sysDictItemDao.updateByExample(record, example);
	}

	@Override
	@CacheEvict(value =CACHE_NAME, key = "#record.id") // 清除 缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByPrimaryKey(SysDictItem record) throws Exception {
		return sysDictItemDao.updateByPrimaryKeySelective(record);
	}
