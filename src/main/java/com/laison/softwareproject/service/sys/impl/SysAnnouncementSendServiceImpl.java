...
import com.laison.softwareproject.dao.sys.SysAnnouncementSendDao;
...
public class SysAnnouncementSendServiceImpl implements SysAnnouncementSendService{
    ...
    @Autowired
	private SysAnnouncementSendDao sysAnnouncementSendDao;
	...
	public int countByCondition(HashMap<String, Object> condition) throws Exception {
		...
		return  sysAnnouncementSendDao.selectCountByExample(example);
	}
	...
	public int deleteByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return  sysAnnouncementSendDao.deleteByExample(example);
	}
	...
	public int deleteByPrimaryKey(String id) throws Exception {
		...
		return  sysAnnouncementSendDao.deleteByPrimaryKey(id);
	}

	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	public int save(SysAnnouncementSend record) throws Exception {
		
		return sysAnnouncementSendDao.insertSelective(record);
	}

	@Override
	public List<SysAnnouncementSend> selectAllByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		...
		return sysAnnouncementSendDao.selectByExample(example);
	}

	@Override
	public PageInfo<SysAnnouncementSend> selectPageByCondition(HashMap<String, Object> condition, Integer pageNum, Integer pageSize)
			throws Exception {
		Example example = createExample(condition);
		if(ConfigConstant.ISOLATE_ENABLE) {
			LoginUserUtil.addIsolate(example);
		...
		List<SysAnnouncementSend> list = sysAnnouncementSendDao.selectByExample(example);
		PageInfo<SysAnnouncementSend> pageInfo = new PageInfo<>(list);
		return pageInfo;
	}

	@Override
	public SysAnnouncementSend selectFirstByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		String orderByClause = (String) condition.get("orderByClause");
		if(orderByClause!=null) {
			example.setOrderByClause(orderByClause);
	...
	public SysAnnouncementSend selectByPrimaryKey(String id) throws Exception {
		return sysAnnouncementSendDao.selectByPrimaryKey(id);
	}

	@Override
	@CacheEvict(value=CACHE_NAME,allEntries=true)// 清空  缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByCondition(SysAnnouncementSend record, HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return sysAnnouncementSendDao.updateByExample(record, example);
	}

	@Override
	@CacheEvict(value =CACHE_NAME, key = "#record.id") // 清除 缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByPrimaryKey(SysAnnouncementSend record) throws Exception {
		return sysAnnouncementSendDao.updateByPrimaryKeySelective(record);
	}
	...
	public int deleteByPrimaryKeys(List<String> ids) throws Exception {
		Example example =new Example(SysAnnouncementSend.class);
