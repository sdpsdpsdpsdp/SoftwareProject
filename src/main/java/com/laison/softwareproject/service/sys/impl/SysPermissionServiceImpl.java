...
import com.laison.softwareproject.dao.sys.SysPermissionDao;
...
public class SysPermissionServiceImpl implements SysPermissionService{
	...
	public int countByCondition(HashMap<String, Object> condition) throws Exception {
		...
		return  sysPermissionDao.selectCountByExample(example);
	}
	...
	public int deleteByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return  sysPermissionDao.deleteByExample(example);
	}
	...
	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	public int save(SysPermission record) throws Exception {
		
		return sysPermissionDao.insertSelective(record);
	}

	@Override
	public List<SysPermission> selectAllByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
	...
	@Override
	public PageInfo<SysPermission> selectPageByCondition(HashMap<String, Object> condition, Integer pageNum, Integer pageSize)
			throws Exception {
		Example example = createExample(condition);
		if(ConfigConstant.ISOLATE_ENABLE) {
			LoginUserUtil.addIsolate(example);
	...
	@Override
	public SysPermission selectFirstByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		String orderByClause = (String) condition.get("orderByClause");
		if(orderByClause!=null) {
			example.setOrderByClause(orderByClause);
	...
	public SysPermission selectByPrimaryKey(String id) throws Exception {
	...
	@CacheEvict(value=CACHE_NAME,allEntries=true)// 清空  缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByCondition(SysPermission record, HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return sysPermissionDao.updateByExample(record, example);
	}
