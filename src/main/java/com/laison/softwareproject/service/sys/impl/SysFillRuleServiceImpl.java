...
import com.laison.softwareproject.dao.sys.SysFillRuleDao;
import com.laison.softwareproject.service.sys.SysFillRuleService;
...
*/
@Service
public class SysFillRuleServiceImpl implements SysFillRuleService{
	
	
    @Autowired
	private SysFillRuleDao sysFillRuleDao;
	...
	public int countByCondition(HashMap<String, Object> condition) throws Exception {
		...
		return  sysFillRuleDao.selectCountByExample(example);
	}
	...
	public int deleteByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return  sysFillRuleDao.deleteByExample(example);
	}
	...
	public int deleteByPrimaryKey(String id) throws Exception {
		...
		return  sysFillRuleDao.deleteByPrimaryKey(id);
	}

	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	public int save(SysFillRule record) throws Exception {
		
		return sysFillRuleDao.insertSelective(record);
	}

	@Override
	public List<SysFillRule> selectAllByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		...
		return sysFillRuleDao.selectByExample(example);
	}

	@Override
	public PageInfo<SysFillRule> selectPageByCondition(HashMap<String, Object> condition, Integer pageNum, Integer pageSize)
			throws Exception {
		Example example = createExample(condition);
		if(ConfigConstant.ISOLATE_ENABLE) {
			LoginUserUtil.addIsolate(example);
		...
		List<SysFillRule> list = sysFillRuleDao.selectByExample(example);
		PageInfo<SysFillRule> pageInfo = new PageInfo<>(list);
		return pageInfo;
	}

	@Override
	public SysFillRule selectFirstByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		String orderByClause = (String) condition.get("orderByClause");
		if(orderByClause!=null) {
			example.setOrderByClause(orderByClause);
	...
	public SysFillRule selectByPrimaryKey(String id) throws Exception {
		return sysFillRuleDao.selectByPrimaryKey(id);
	}

	@Override
	@CacheEvict(value=CACHE_NAME,allEntries=true)// 清空  缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByCondition(SysFillRule record, HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return sysFillRuleDao.updateByExample(record, example);
	}

	@Override
	@CacheEvict(value =CACHE_NAME, key = "#record.id") // 清除 缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByPrimaryKey(SysFillRule record) throws Exception {
		return sysFillRuleDao.updateByPrimaryKeySelective(record);
	}
	...
	public int deleteByPrimaryKeys(List<String> ids) throws Exception {
		Example example =new Example(SysFillRule.class);
