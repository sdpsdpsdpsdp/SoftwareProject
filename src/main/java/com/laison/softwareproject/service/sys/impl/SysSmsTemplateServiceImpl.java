...
import com.laison.softwareproject.dao.sys.SysSmsTemplateDao;
import com.laison.softwareproject.service.sys.SysSmsTemplateService;
...
public class SysSmsTemplateServiceImpl implements SysSmsTemplateService{
	...
	public int countByCondition(HashMap<String, Object> condition) throws Exception {
		...
		return  sysSmsTemplateDao.selectCountByExample(example);
	}
	...
	public int deleteByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return  sysSmsTemplateDao.deleteByExample(example);
	}
	...
	public int deleteByPrimaryKey(String id) throws Exception {
		...
		return  sysSmsTemplateDao.deleteByPrimaryKey(id);
	}

	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	public int save(SysSmsTemplate record) throws Exception {
		
		return sysSmsTemplateDao.insertSelective(record);
	}

	@Override
	public List<SysSmsTemplate> selectAllByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		...
		return sysSmsTemplateDao.selectByExample(example);
	}

	@Override
	public PageInfo<SysSmsTemplate> selectPageByCondition(HashMap<String, Object> condition, Integer pageNum, Integer pageSize)
			throws Exception {
		Example example = createExample(condition);
		if(ConfigConstant.ISOLATE_ENABLE) {
			LoginUserUtil.addIsolate(example);
		...
		List<SysSmsTemplate> list = sysSmsTemplateDao.selectByExample(example);
		PageInfo<SysSmsTemplate> pageInfo = new PageInfo<>(list);
		return pageInfo;
	}

	@Override
	public SysSmsTemplate selectFirstByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		String orderByClause = (String) condition.get("orderByClause");
		if(orderByClause!=null) {
			example.setOrderByClause(orderByClause);
	...
	public SysSmsTemplate selectByPrimaryKey(String id) throws Exception {
		return sysSmsTemplateDao.selectByPrimaryKey(id);
	}

	@Override
	@CacheEvict(value=CACHE_NAME,allEntries=true)// 清空  缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByCondition(SysSmsTemplate record, HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return sysSmsTemplateDao.updateByExample(record, example);
	}

	@Override
	@CacheEvict(value =CACHE_NAME, key = "#record.id") // 清除 缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByPrimaryKey(SysSmsTemplate record) throws Exception {
		return sysSmsTemplateDao.updateByPrimaryKeySelective(record);
	}
	...
	public int deleteByPrimaryKeys(List<String> ids) throws Exception {
		Example example =new Example(SysSmsTemplate.class);
