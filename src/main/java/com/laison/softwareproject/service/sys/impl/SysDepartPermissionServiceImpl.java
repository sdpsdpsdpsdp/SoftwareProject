...
import com.laison.softwareproject.dao.sys.SysDepartPermissionDao;
...
public class SysDepartPermissionServiceImpl implements SysDepartPermissionService{
	...
	public int countByCondition(HashMap<String, Object> condition) throws Exception {
		...
		return  sysDepartPermissionDao.selectCountByExample(example);
	}
	...
	public int deleteByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return  sysDepartPermissionDao.deleteByExample(example);
	}
	...
	public int deleteByPrimaryKey(String id) throws Exception {
		...
		return  sysDepartPermissionDao.deleteByPrimaryKey(id);
	}

	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	public int save(SysDepartPermission record) throws Exception {
		
		return sysDepartPermissionDao.insertSelective(record);
	}

	@Override
	public List<SysDepartPermission> selectAllByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		...
		return sysDepartPermissionDao.selectByExample(example);
	}

	@Override
	public PageInfo<SysDepartPermission> selectPageByCondition(HashMap<String, Object> condition, Integer pageNum, Integer pageSize)
			throws Exception {
		Example example = createExample(condition);
		if(ConfigConstant.ISOLATE_ENABLE) {
			LoginUserUtil.addIsolate(example);
		...
		List<SysDepartPermission> list = sysDepartPermissionDao.selectByExample(example);
		PageInfo<SysDepartPermission> pageInfo = new PageInfo<>(list);
		return pageInfo;
	}

	@Override
	public SysDepartPermission selectFirstByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		String orderByClause = (String) condition.get("orderByClause");
		if(orderByClause!=null) {
			example.setOrderByClause(orderByClause);
	...
	public SysDepartPermission selectByPrimaryKey(String id) throws Exception {
		return sysDepartPermissionDao.selectByPrimaryKey(id);
	}

	@Override
	@CacheEvict(value=CACHE_NAME,allEntries=true)// 清空  缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByCondition(SysDepartPermission record, HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return sysDepartPermissionDao.updateByExample(record, example);
	}

	@Override
	@CacheEvict(value =CACHE_NAME, key = "#record.id") // 清除 缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByPrimaryKey(SysDepartPermission record) throws Exception {
		return sysDepartPermissionDao.updateByPrimaryKeySelective(record);
	}
	...
	public int deleteByPrimaryKeys(List<String> ids) throws Exception {
		Example example =new Example(SysDepartPermission.class);
