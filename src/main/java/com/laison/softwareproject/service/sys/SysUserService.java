...
public interface SysUserService extends BaseService<SysUser, String> {
    ...
    Result login(SysLoginModel sysLoginModel) throws Exception;

    LoginAppUser findByUsername(String username) throws UsernameNotFoundException;
}
