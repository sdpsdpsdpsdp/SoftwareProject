...
import com.laison.softwareproject.dao.sys.SysDataSourceDao;
import com.laison.softwareproject.service.sys.SysDataSourceService;
...
public class SysDataSourceServiceImpl implements SysDataSourceService{
	...
	public int countByCondition(HashMap<String, Object> condition) throws Exception {
		...
		return  sysDataSourceDao.selectCountByExample(example);
	}
	...
	public int deleteByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return  sysDataSourceDao.deleteByExample(example);
	}
	...
	public int deleteByPrimaryKey(String id) throws Exception {
		...
		return  sysDataSourceDao.deleteByPrimaryKey(id);
	}

	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	public int save(SysDataSource record) throws Exception {
		
		return sysDataSourceDao.insertSelective(record);
	}

	@Override
	public List<SysDataSource> selectAllByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		...
		return sysDataSourceDao.selectByExample(example);
	}

	@Override
	public PageInfo<SysDataSource> selectPageByCondition(HashMap<String, Object> condition, Integer pageNum, Integer pageSize)
			throws Exception {
		Example example = createExample(condition);
		if(ConfigConstant.ISOLATE_ENABLE) {
			LoginUserUtil.addIsolate(example);
		...
		List<SysDataSource> list = sysDataSourceDao.selectByExample(example);
		PageInfo<SysDataSource> pageInfo = new PageInfo<>(list);
		return pageInfo;
	}

	@Override
	public SysDataSource selectFirstByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		String orderByClause = (String) condition.get("orderByClause");
		if(orderByClause!=null) {
			example.setOrderByClause(orderByClause);
	...
	public SysDataSource selectByPrimaryKey(String id) throws Exception {
		return sysDataSourceDao.selectByPrimaryKey(id);
	}

	@Override
	@CacheEvict(value=CACHE_NAME,allEntries=true)// 清空  缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByCondition(SysDataSource record, HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return sysDataSourceDao.updateByExample(record, example);
	}

	@Override
	@CacheEvict(value =CACHE_NAME, key = "#record.id") // 清除 缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByPrimaryKey(SysDataSource record) throws Exception {
		return sysDataSourceDao.updateByPrimaryKeySelective(record);
	}
