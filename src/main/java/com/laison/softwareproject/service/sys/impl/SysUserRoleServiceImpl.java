...
import com.laison.softwareproject.dao.sys.SysUserRoleDao;
...
public class SysUserRoleServiceImpl implements SysUserRoleService{
	...
	public int countByCondition(HashMap<String, Object> condition) throws Exception {
		...
		return  sysUserRoleDao.selectCountByExample(example);
	}
	...
	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	public int save(SysUserRole record) throws Exception {
		
		return sysUserRoleDao.insertSelective(record);
	}

	@Override
	public List<SysUserRole> selectAllByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
	...
	@Override
	public PageInfo<SysUserRole> selectPageByCondition(HashMap<String, Object> condition, Integer pageNum, Integer pageSize)
			throws Exception {
		Example example = createExample(condition);
		if(ConfigConstant.ISOLATE_ENABLE) {
			LoginUserUtil.addIsolate(example);
	...
	@Override
	public SysUserRole selectFirstByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		String orderByClause = (String) condition.get("orderByClause");
		if(orderByClause!=null) {
			example.setOrderByClause(orderByClause);
	...
	public SysUserRole selectByPrimaryKey(String id) throws Exception {
	...
	@CacheEvict(value=CACHE_NAME,allEntries=true)// 清空  缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByCondition(SysUserRole record, HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return sysUserRoleDao.updateByExample(record, example);
	}
