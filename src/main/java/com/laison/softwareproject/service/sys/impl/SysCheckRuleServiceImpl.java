...
import com.laison.softwareproject.dao.sys.SysCheckRuleDao;
...
*/
@Service
public class SysCheckRuleServiceImpl implements SysCheckRuleService{
	
	
    @Autowired
	private SysCheckRuleDao sysCheckRuleDao;
	...
	public int countByCondition(HashMap<String, Object> condition) throws Exception {
		...
		return  sysCheckRuleDao.selectCountByExample(example);
	}
	...
	public int deleteByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return  sysCheckRuleDao.deleteByExample(example);
	}
	...
	public int deleteByPrimaryKey(String id) throws Exception {
		...
		return  sysCheckRuleDao.deleteByPrimaryKey(id);
	}

	@Override
	@Transactional(propagation = Propagation.REQUIRED)
	public int save(SysCheckRule record) throws Exception {
		
		return sysCheckRuleDao.insertSelective(record);
	}

	@Override
	public List<SysCheckRule> selectAllByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		...
		return sysCheckRuleDao.selectByExample(example);
	}

	@Override
	public PageInfo<SysCheckRule> selectPageByCondition(HashMap<String, Object> condition, Integer pageNum, Integer pageSize)
			throws Exception {
		Example example = createExample(condition);
		if(ConfigConstant.ISOLATE_ENABLE) {
			LoginUserUtil.addIsolate(example);
		...
		List<SysCheckRule> list = sysCheckRuleDao.selectByExample(example);
		PageInfo<SysCheckRule> pageInfo = new PageInfo<>(list);
		return pageInfo;
	}

	@Override
	public SysCheckRule selectFirstByCondition(HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		String orderByClause = (String) condition.get("orderByClause");
		if(orderByClause!=null) {
			example.setOrderByClause(orderByClause);
	...
	public SysCheckRule selectByPrimaryKey(String id) throws Exception {
		return sysCheckRuleDao.selectByPrimaryKey(id);
	}

	@Override
	@CacheEvict(value=CACHE_NAME,allEntries=true)// 清空  缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByCondition(SysCheckRule record, HashMap<String, Object> condition) throws Exception {
		Example example = createExample(condition);
		return sysCheckRuleDao.updateByExample(record, example);
	}

	@Override
	@CacheEvict(value =CACHE_NAME, key = "#record.id") // 清除 缓存
	@Transactional(propagation = Propagation.REQUIRED)
	public int updateByPrimaryKey(SysCheckRule record) throws Exception {
		return sysCheckRuleDao.updateByPrimaryKeySelective(record);
	}
	...
	public int deleteByPrimaryKeys(List<String> ids) throws Exception {
		Example example =new Example(SysCheckRule.class);
