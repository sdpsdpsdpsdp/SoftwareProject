package com.laison.softwareproject.service.common.impl;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.JSONObject;
import com.google.common.base.Joiner;
import com.laison.softwareproject.common.api.dto.DynamicDataSourceModel;
import com.laison.softwareproject.common.constants.CacheConstant;
import com.laison.softwareproject.common.constants.SymbolConstant;
import com.laison.softwareproject.common.constants.WebsocketConst;
import com.laison.softwareproject.common.utils.SensitiveInfoUtil;
import com.laison.softwareproject.common.utils.oConvertUtils;
import com.laison.softwareproject.dao.sys.*;
import com.laison.softwareproject.model.common.DictModel;
import com.laison.softwareproject.model.common.SysPermissionDataRuleModel;
import com.laison.softwareproject.model.common.SysUserCacheInfo;
import com.laison.softwareproject.model.sys.*;
import com.laison.softwareproject.service.common.ISysBaseAPI;
...
//
//    @Autowired
//    private SysSmsTemplateService sysMessageTemplateService;
//    @Resource
...
//    @Resource
//    private SysAnnouncementDao sysAnnouncementMapper;
//    @Resource
//    private SysAnnouncementSendDao sysAnnouncementSendMapper;
//    @Resource
//    private WebSocket webSocket;
//    @Resource
//    private SysRoleDao roleMapper;
//    @Resource
//    private SysDepartDao departMapper;
//    @Resource
//    private SysCategoryDao categoryMapper;
//    @Autowired
...
//        SysUser user = sysUserService.getEncodeUserInfo(username);
...
//            criteria.andEqualTo("component", component);
//            criteria.andEqualTo("delFlag", false);
//            currentSyspermission = sysPermissionMapper.selectByExample(example);
//        } else {
//            //1.直接通过前端请求地址查询菜单
...
//
//    @Override
//    public List<SysUser> queryAllUserByIds(String[] userIds) {
//        QueryWrapper<SysUser> queryWrapper = new QueryWrapper<SysUser>().eq("status", 1).eq("del_flag", 0);
...
//
//    @Override
//    public List<SysUser> queryUserByNames(String[] userNames) {
//        QueryWrapper<SysUser> queryWrapper = new QueryWrapper<SysUser>().eq("status", 1).eq("del_flag", 0);
...
//
//    @Override
//    public void updateAvatar(SysUser SysUser) {
//        SysUser sysUser = new SysUser();
//        BeanUtils.copyProperties(SysUser, sysUser);
